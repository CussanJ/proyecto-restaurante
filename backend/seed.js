...
async function seed() {
  await mongoose.connect(process.env.MONGODB_URI || 'mongodb://mongodb:27017/productos_db');
  ...
  await mongoose.connect(process.env.MONGODB_URI_INVENTARIO || 'mongodb://mongodb:27017/inventario_db');
